...
runInPath("archive", function() {
	webLink = "https://gitlab.gnome.org/GNOME/libxslt/-/archive/v" + Project.version + "/libxslt-v" + Project.version + ".tar.gz";
	...
	Shell.rename("libxslt-v" + Project.version, "libxslt-" + Project.version);
